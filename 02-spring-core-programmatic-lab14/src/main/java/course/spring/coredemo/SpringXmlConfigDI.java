...
import course.spring.coredemo.config.ProgrammaticAnnotationConfig;
...
public class SpringXmlConfigDI {
    public static void main(String[] args) {
        AbstractApplicationContext ctx = new AnnotationConfigApplicationContext(ProgrammaticAnnotationConfig.class);
