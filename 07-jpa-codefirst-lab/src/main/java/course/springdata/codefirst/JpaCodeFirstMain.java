...
//        Company company1 = new Company(new BigInteger("1234560002"), "Acme Inc.");
//        Plane plane1 = new Plane("Boing", new BigDecimal(5400000), "kerosene", 120, company1);
...
//        em.createQuery("SELECT v FROM Vehicle v ")
        em.createQuery("SELECT p FROM Plane p WHERE p.company.name LIKE :name ORDER BY p.company.name")
                .setParameter("name", "Soft%")
