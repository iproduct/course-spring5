...
//        expression2.setValue(context2,"new engine model");
        List result2 = expression2.getValue(context2, List.class);
        ...
        Expression expression3 = parser.parseExpression("cars.![model]");
...
//        EvaluationContext context6 = new StandardEvaluationContext(mapOfMaps);
        Expression exp4 = parser.parseExpression("#tesla['name']['first'] + ' ' + #tesla['name']['last']");
