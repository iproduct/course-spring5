...
//    @Inject
//    public ConsoleArticlePresenter(@Qualifier("alternativeProvider") ArticleProvider myprovider) {
...
//    @AlternativeProvider
//    @Inject
    public void setArticleProvider(ArticleProvider alternativeProvider) {
